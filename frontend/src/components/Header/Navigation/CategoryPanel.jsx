...
const CategoryPanel = (props) => {
  ...
  const openInnerSubmenu = (index) => {
    if(innerSubmenuIndex === index) {
      setInnerSubmenuIndex(null); // Close the submenu if it's already open
    }else{
      ...
      <div className="scroll">
        <ul className="w-full">
          <li className="list-none flex items-center relative flex-col">
            ...
            {
              submenuIndex === 0 ? 
                                <FaRegMinusSquare className="absolute top-[10px] right-[15px] cursor-pointer" onClick={()=>openSubmenu(null)}/>
:
            ...
            {submenuIndex === 0 && (
              <ul className="submenu w-full pl-3">
                <li className="list-none relative">
                  ...
                  {
              innerSubmenuIndex === 0 ? 
                                <FaRegMinusSquare className="absolute top-[10px] right-[15px] cursor-pointer" onClick={()=>openInnerSubmenu(null)}/>
:
